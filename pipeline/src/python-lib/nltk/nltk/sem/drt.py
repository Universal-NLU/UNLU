...
class DrtConcatenation(DrtBooleanExpression):
    ...
    def simplify(self):
        ...
        print ("------------ Beginning of a new iteration -----------------")   # Debug
        print ("Self:")                                        # Debug
        print(str(self))                                       # Debug
        self.pretty_print()                                    # Debug
        print("First before simplify:")                        # Debug
        self.first.pretty_print()                              # Debug
        first = self.first.simplify()
        print("First after simplify:")                         # Debug
        first.pretty_print()                                   # Debug


        print("Second before simplify:")                       # Debug
        self.second.pretty_print()                             # Debug
        second = self.second.simplify()
        print("Second after simplify:")                        # Debug
        second.pretty_print()                                  # Debug

        print("Consequent before simplify:")                   # Debug
        if (self.consequent):                                  # Debug
            self.consequent.pretty_print()                     # Debug
        else:                                                  # Debug
            pass                                               # Debug

        consequent = self.consequent.simplify() if self.consequent else None

        print("Consequent after simplify:")                    # Debug
        if (consequent !=None):                                # Debug
            consequent.pretty_print()                          # Debug
        else:                                                  # Debug
            pass                                               # Debug
        ...
        if isinstance(first, DRS) and isinstance(second, DRS):
            ...
            print("First and second are both DRSes.")           # Debug
            ...
            print("Second after alpha convert: ")              # Debug
            second.pretty_print()

            print("Returning the DRS from this step: ")                              # Debug
            DRS(first.refs + second.refs, first.conds + second.conds, consequent).pretty_print()     # Debug

            return DRS(first.refs + second.refs, first.conds + second.conds, consequent)
        else:
            print("First or second is not a DRS so returning the following:")       # Debug
            self.__class__(first, second, consequent).pretty_print() # Debug
            return self.__class__(first, second, consequent)
